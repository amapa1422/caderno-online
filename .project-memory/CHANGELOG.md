...
Adicionar exclusivamente cinco categorias visuais com as artes fornecidas,
preservando Normal, Homem-Aranha, Venom e toda a logica do caderno.
Espetacular-Homem Aranha e Flamengo herdam paleta Spider; Santos e Sao Paulo,
Venom. Times sem teias. Bolsonaro usa superficies verdes, dourado, selecao azul
e brilho CSS discreto (opacidade, 12s), desativado com movimento reduzido.
Navegacao de datas recebe fundo legivel apenas nas novas skins, sem alterar
geometria. Oito opcoes nativas no seletor; mesma chave caderno-visual-theme e
mesmo fluxo de load/change/fallback, sem migracao ou escrita Firebase.

### Arquivos

Alterados no produto: index.html (somente options), visual-themes.js (whitelist),
visual-themes.css (seletores, tokens, fundos e animacao isolada).
Novos assets: assets/themes/categories/espetacular.png, santos.png, flamengo.png,
sao-paulo.png, bolsonaro.png e README.md. Sao os anexos 1/5/6/7/8; os demais eram
capturas de referencia. Copiados sem regeneracao. Total de imagens: 10.318.928 bytes.
Recuperados do historico ac8158f: .project-memory/ e tests/, removidos em b57aa73.
Memoria atualizada: CURRENT_STATE, CHANGELOG, PROMPTS, DECISIONS (DEC-0013),
ARCHITECTURE, KNOWN_ISSUES, README; novos checkpoints CP-0015.md e CP-0016.md.
Historico anterior preservado. ROLLBACK e CP-0001 a CP-0014 recuperados intactos;
tags antigas ausentes nao recriadas, commits historicos conferidos por hash.
Testes recuperados: README.md, browser.ps1, browser-checks.js, firebase.mock.js,
reload-checks.js, responsive-checks.js, visual-theme-checks.js, visual-themes.ps1,
normal-comparison.ps1. Adaptados ao app b57aa73 e oito skins; mock administrativo
sem chamadas reais, sem importacao automatica de notas anonimas como na base.

### Preservacao

app.js, style.css, color.js, accounts.js, firebase.js, firestore.rules, functions/,
config Firebase, package.json/lock, icone, design_system e assets antigos identicos
a CP-0015. Nenhum novo backend, PWA, dependencia, rollback de app, push ou deploy.
Memoria descreve as mudancas observadas em b57aa73 sem inventar pedido ou validacao.

### Validacao executada

- Edge headless/CDP: tests/browser.ps1 -VisualThemes -BrowserPath msedge.exe.
  129 checks de oito opcoes, persistencia/isolamento, fontes, cores, grifos, editor
  aberto, rascunho/data, assets HTTP 200, decodificacao e fundo correto.
- 80 combinacoes: 1920x1080, 1440x900, 1280x720, 390x844, 430x932 x claro/escuro
  x oito skins, sem overflow. Contraste texto/legenda/botao >=4,5:1; navegacao
  das novas skins >=8,92:1. Nao equivale a auditoria WCAG completa.
- Teclado nativo no select; oito reloads preservam tema e grifo #22AACC; aplicacao
  precoce, valor invalido e storage bloqueado; glow exclusivo e reduced-motion.
  Capturas login/drawers/picker/dialog; imagens desktop/mobile inspecionadas.
- Comparacao Normal/CP-0015 no mesmo Edge: ZERO pixels diferentes em quatro
  combinacoes (1440x900 e 390x844, claro/escuro).
- Chrome headless/CDP: tests/browser.ps1 -Skin bolsonaro, 112 checks: 75 funcionais,
  21 em dois reloads e 16 mobile/teclado. CRUD, autosave, falhas/retry, grifo,
  conclusao, exclusao confirmada, busca, calendario, sessao e rascunhos.
  Mouse/toque, nove larguras 320-1920 nos dois modos, viewport 390x360 e
  reduced-motion. Fonte Segoe Print identificada pelo runner.
- Console sem erros nas duas suites, nenhuma falha de asset dos temas.
  Firebase simulado somente no servidor 127.0.0.1; sem login ou escrita real.
- git diff --check e igualdade de arquivos preservados aprovados.

O runner inicialmente falhou no sandbox por HttpListener e depois teve timeout
de download: fetch nao consumia o corpo antes do segundo pedido ao servidor
sequencial. Corrigido apenas no teste (arrayBuffer); browser flags evitam
throttling headless. Suite visual final repetida apos ajuste de contraste da
navegacao; resultados finais acima. Artefatos em tests/.artifacts/ ignorados.

### Limites e impactos

Bolsonaro fornecido em 499x367 pode perder nitidez em telas grandes; cover recorta
conforme viewport. Sem preload de todos os fundos; primeira carga depende do peso
da imagem escolhida (0,26-4,86 MB). Preservadas imagens recebidas sem gerar substitutas.
Contas/regras/Firestore reais, sincronizacao entre aparelhos, Safari/iOS, teclado
fisico mobile e leitores de tela nao homologados. Scripts npm da base apontam
para arquivos ausentes (ISSUE-0011); fora deste pedido visual. ISSUE-0010 corrigida
para memoria/testes; tags antigas ausentes permanecem documentadas.
Resultado: concluido e validado localmente; nao e homologacao de producao.
## CHANGE-0008
