...
Titulo: Expandir skins existentes e animar somente a ambientacao Brasil.
Status: Ativa. Substitui DEC-0012 no conjunto de skins e na proibicao de animacao
decorativa; conserva separacao entre aparencia, claro/escuro, dados e logica.
Data: 2026-09-25. Origem: PROMPT-0009 / CHANGE-0009.
Motivo: Novo pedido solicita cinco categorias e animacao leve no tema Bolsonaro.
Decisao: Reutilizar data-visual-theme, caderno-visual-theme e os tokens atuais;
agrupar seletores para herdar paletas sem duplicar componentes ou mudar o layout.
Novos fundos sao os anexos do usuario, sem geracao. Capturas do app nao sao fundos.
Somente Bolsonaro recebe um brilho CSS de opacidade atras do conteudo, desativado
sob reduced-motion. Sem animar campos/controles, sem canvas/timers/dependencias.
Memoria e suite local ausentes no checkout foram recuperadas de ac8158f por
exigencia do AGENTS.md. Docs atualizadas para refletir b57aa73; nenhum rollback
de produto. Tags historicas ausentes nao sao recriadas nem consideradas verificadas.
Arquivos: index.html, visual-themes.js/css, assets/themes/categories/, tests/ e memoria.
## DEC-0012

Título: Skins nativas opcionais e independentes do tema claro/escuro e dos dados.
Status: Substituída por DEC-0013 quanto ao conjunto de skins/assets e à ausência de animação decorativa. Demais limites de isolamento preservados.
