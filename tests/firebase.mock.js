...
// Compatibility with accounts.js introduced in b57aa73. Never calls Firebase.
export async function createCadernoUser() { throw { code: 'functions/permission-denied' }; }
