# Same browser, fixtures, viewport and motion settings, before/after CP-0013.
...
foreach ($name in @('index.html','style.css','app.js','color.js')) {
    $source = git -C $repoRoot show "CP-0013:$name"
...
Write-Output 'NORMAL_PIXELS=PASS (CP-0013 vs current, light/dark, desktop/mobile; only appearance control differs)'
